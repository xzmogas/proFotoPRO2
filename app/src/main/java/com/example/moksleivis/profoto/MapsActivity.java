...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        entrySubmitKu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent goToNewEntryActivity = new Intent(MapsActivity.this, NewEntryActivity.class);
                // atidarome ta langa
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(54.68916, 25.2798);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Vilnius"));
